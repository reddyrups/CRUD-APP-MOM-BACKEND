...
app.post('/api/records', (req, res) => {
  ...
  const record = { item: req.body.item, ownerName: req.body.ownerName, eta: req.body.eta, comments: req.body.comments };
...
app.put('/api/records/:id', (req, res) => {
    ...
    const record = { item: req.body.item, ownerName: req.body.ownerName, eta: req.body.eta, comments: req.body.comments };
    connection.query('UPDATE records SET ? MomDetails id = ?', [record, id], (err, results) => {
      if (err) throw err;
